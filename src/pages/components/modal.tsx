...
const ModalContainer = dynamic(import('../../../doc/modal/bContentContainer'), { ssr: true });
...
const markDown = 'In order to make modal stay on top all the time, you need to place Modal component at page level.';
...
const ModalPage: NextPage<DocProps> = ({
  doc,
}) => {
  return (
